...
raw="https://github.com/EnergizedProtection/block/raw/master/extensions/$pack/formats"
...
wget -qO- https://www.malwaredomainlist.com/hostslist/ip.txt; \
wget -qO- https://pgl.yoyo.org/adservers/iplist.php?ipformat=plain&showintro=1&mimetype=plaintext; \
wget -qO- https://ransomwaretracker.abuse.ch/downloads/RW_IPBL.txt; \
wget -qO- http://www.urlvir.com/export-ip-addresses/; \
wget -qO- https://feodotracker.abuse.ch/downloads/ipblocklist.txt
